...
cs=Pin(1,Pin.OUT)
res=Pin(4,Pin.OUT)
disp=SSD1322_SPI(256,64,spi,dc,cs,res)
disp.fill(0)
while True:
    disp.fill(0)
    for x in range(255):
        disp.fill(0)
        disp.pixel(x,20,0xff)
        disp.pixel(x-1,20,0x05)
        disp.pixel(x-2,20,0x04)
        disp.pixel(x-3,20,0x03)
        disp.pixel(x-4,20,0x02)
        disp.pixel(x-5,20,0x01)
        disp.text(str(x),3,40,0xff)
        disp.show()
    # for x in range(255):

    #     disp.fill(0)
    #     #print(x)
    #     disp.line(x,5,x,60,0xff)
    #     disp.show()
    #     time.sleep(0.001)
    # for x in range(255):
    ...
    #     disp.fill(0)
    #     #print(x)
    #     disp.line(255-x,5,255-x,60,0xff)
    #     disp.show()
    #     time.sleep(0.001)
